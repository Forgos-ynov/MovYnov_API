 ...
 */
final class Version20230505131942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE forum_post (id INT AUTO_INCREMENT NOT NULL, id_forum_category_id INT NOT NULL, id_user_id INT NOT NULL, content LONGTEXT NOT NULL, id_media INT NOT NULL, spoilers TINYINT(1) NOT NULL, uuid LONGTEXT NOT NULL, is_deleted TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_996BCC5AE5457657 (id_forum_category_id), INDEX IDX_996BCC5A79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
